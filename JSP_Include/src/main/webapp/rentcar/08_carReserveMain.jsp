...
<head>
<meta charset="UTF-8">
<title>08_carReserveMain.jsp</title>
</head>
<body>
	...
	<div align="center">
		<table>
			<tr height="60">
				<td align="center" colspan="3"><font size="6" color="gray">최신형자동차</font></td>
			</tr>
			<tr height="240">
				<%
		...
		<!-- 전체 검색을 눌렀을 때 -->
		<button onclick="location.href='01_main.jsp?center=09_carAllList.jsp'">전체검색</button>
	</div>
