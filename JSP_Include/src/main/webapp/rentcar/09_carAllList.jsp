...
<body>
	<div align="center">
		<table>
			<tr height="60">
				<td align="center" colspan="3"><font size="6" color="gray">전체렌트카 보기</font></td>
			</tr>
			
			<%
				RentcarDAO rdao = RentcarDAO.instance;
			...
			<tr height="220">
				...
				<td width = "333" align="center">
					<a href = "01_main.jsp?center=10_carReserveInfo.jsp?no=<%=v.get(i).getNo() %>"> 
						<img alt="" src="imgcar/<%=v.get(i).getImg()%>" width="300" height="200">
					</a>
					<p>
