...
public class RentcarDAO {
	...
	//최신순 자동차 3개만 뿌려주는 데이터를 가져옴(08_carReserveMain.jsp)
	...
	//getCategoryCar(category)(13_carCategoryList.jsp에 사용되는 메서드)
	...
	//getOneCar(no) 리스트에서 no를 이용해서 데이터를 꺼내가기 (10_carReserveInfo.jsp)
	...
	// 예약 리스트에 저장하기 (12_carReserveResult.jsp)
	...
	// 차량 예약 완료화면 보여주는 리스트 14_carReserveView.jsp
